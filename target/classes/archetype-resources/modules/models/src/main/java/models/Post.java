...
import ${package}.models.Media;
import ${package}.models.PostAllOf;
...
/**
 * The REST resource for a Post (derived from PostEntity)
 */
@ApiModel(description = "The REST resource for a Post (derived from PostEntity)")
...
public class Post  implements Serializable {
  ...
  */
  ...
  public Post mimeType(String mimeType) {
  ...
  */
  ...
  public Post fileName(String fileName) {
  ...
  */
  ...
  public Post sizeInBytes(Integer sizeInBytes) {
  ...
  */
  ...
  public Post created(LocalDateTime created) {
  ...
  */
  ...
  public Post reviewed(Boolean reviewed) {
  ...
  */
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, post.id) && 
        Objects.equals(this.mimeType, post.mimeType) && 
        Objects.equals(this.fileName, post.fileName) && 
        Objects.equals(this.sizeInBytes, post.sizeInBytes) && 
        Objects.equals(this.created, post.created) && 
        Objects.equals(this.modified, post.modified) && 
        Objects.equals(this.reviewed, post.reviewed) && 
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, mimeType, fileName, sizeInBytes, created, modified, reviewed, owner, type, author, tags, comments);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class Post {${symbol_escape}n");
